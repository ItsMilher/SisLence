<?php
	...
	if(empty($_REQUEST['cl']) || empty($_REQUEST['f']) )
	{
		...
		// $usuarios = mysqli_query($conexion, "SELECT * FROM usuario WHERE idusuario = $codusuario");
		// $result_usuario = mysqli_fetch_assoc($usuarios);
		...
		// $pdf->Cell(60, 5, "Datos de Vendedorr/a", 0, 1, 'L');
		// $pdf->Cell(40, 5, "Nombre", 0, 0, 'L');
		// $pdf->Cell(40, 5, utf8_decode($result_usuario['nombre']), 0, 0, 'L');
