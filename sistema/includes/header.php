...
<body id="page-top" >
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content" >
				<!-- Topbar -->
				<nav class="navbar navbar-expand navbar-light bg-color9 text-white topbar mb-3 static-top shadow " id="accordionSidebar">
					...
					<div class="input-group">
						...
						<p class="ml-auto"><strong>Perú, </strong><?php echo fechaPeru(''); ?> &nbsp; <strong>Hora:</strong><?php echo date('H:i:s a');?>
				        </p>
					</div>
					<!-- Topbar Navbar -->
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							...
							<span class="badge bg-linea text-c2">En Línea</span>
							    <img class="img-profile rounded-circle" src="../sistema/img/perfil.jpg">
							</a>
