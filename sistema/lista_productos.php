			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query2 = mysqli_query($conexion, "SELECT r.codproducto, r.descripcion, r.precio, r.precio_cuarto, r.precio_venta, r.precio_final, r.proveedor ,r.existencia, u.codproveedor, u.proveedor  FROM proveedor u INNER JOIN producto r ON u.codproveedor = r.proveedor");
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query2)) { ?>
								<tr>
									...
									<td><?php echo $data['precio_cuarto']; ?></td>
									<td><?php echo $data['precio_venta']; ?></td>
									<td><?php echo $data['precio_final']; ?></td>									
